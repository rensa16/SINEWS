                                ...
                                <section class="section">
                                    ...
                                    <div class="section-content">
                                        <div class="row latest-articles">
                                            <input type="hidden" id="post_load_more_count" value="<?php echo $post_load_more_count; ?>">
                                            <input type="hidden" id="index_visible_posts_count" value="<?php echo $visible_posts_count; ?>">
                                            <div id="last_posts_content">
                                                <?php $this->load->view('post/_index_latest_posts', ["skip" => 0, "visible_posts_count" => $visible_posts_count]); ?>
                                            </div>
                                        </div>
                                    ...
                                    <?php if ($this->total_posts_count > $visible_posts_count): ?>
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="row">
