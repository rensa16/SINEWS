...
<head>
    ...
    <style>
        @media (max-width: 768px){.skin-blue .main-header .navbar .dropdown-menu li a{color:#55606e!important}.skin-blue .main-header .navbar .dropdown-menu li a:hover{background-color:#ebebeb!important}}.sidebar-collapse .user-panel img{display:none}
    </style>
</head>
