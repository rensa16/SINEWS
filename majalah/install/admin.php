...
if (isset($_POST["btn_admin"])) {
    ...
    $variables = update_config_admin($_POST['admin_username'], $_POST['admin_email'], $_POST['admin_password']);
    ...
    if (mysqli_connect_errno()) {
        ...
        mysqli_query($connection, "INSERT INTO users (id, username, slug, email, email_status, token, password, role, user_type, status) 
VALUES (1, '" . $variables["admin_username"] . "', '" . $slug . "', '" . $variables["admin_email"] . "',1 ,'" . uniqid() . "', '" . $password . "', 'admin', 'registered', 1)");
        mysqli_query($connection, "UPDATE general_settings SET vr_key='" . $variables["license_code"] . "', purchase_code='" . $variables["purchase_code"] . "' WHERE id='1'");
