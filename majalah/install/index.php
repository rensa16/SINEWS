                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <textarea name="license_code" class="form-control form-input" style="resize: vertical; height: 100px;line-height: 24px;padding: 10px;" placeholder="Enter anything" required><?php echo @$variables['license_code']; ?></textarea>
                                            </div>
